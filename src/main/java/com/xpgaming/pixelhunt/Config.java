...
public class Config {
    ...
    public void configCreate() throws ObjectMappingException, IOException {
        try {
            ...
            CommentedConfigurationNode huntconfig = config.getNode("pixelhunt").setComment("PixelHunt coded by Xenoyia (@Xenoyia#0001 on Discord)\nUpdated by Blue (Blue#0420)");
            huntconfig.getNode("gui","gui-title").setComment("Title");
            huntconfig.getNode("gui","gui-title").setValue("&b&lPixel Hunt");
            huntconfig.getNode("gui","gui-book-display").setComment("Help Book Item Display Name");
            ...
            huntconfig.getNode("lang","all-random").setComment("/newhunt");
            huntconfig.getNode("lang","all-random").setValue("&aAll Pokémon in the hunt have been randomised!");
            huntconfig.getNode("lang","new-hunt").setValue("New Pok\u00E9mon to hunt is \u00A7a<pokemon> \u00A7f!");
            huntconfig.getNode("lang","hunt-ended").setValue("The hunt for \u00A7a<pokemon> \u00A7fhas ended!");
            huntconfig.getNode("lang","balls").setValue("Balls");
            huntconfig.getNode("lang","money").setValue("Money");
            huntconfig.getNode("lang","candies").setValue("Rare Candies");
            huntconfig.getNode("lang","other").setValue("Other");
            huntconfig.getNode("lang","natures").setValue("Natures");
            huntconfig.getNode("lang","rewards").setValue("Rewards");
            huntconfig.getNode("lang","expiry").setValue("Expiry");
            huntconfig.getNode("lang","unitDays").setValue("D");
            huntconfig.getNode("lang","unitHours").setValue("H");
            huntconfig.getNode("lang","unitSeconds").setValue("S");
